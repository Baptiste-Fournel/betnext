...
| M2 | **Hexagonal & frontières** | domain/application/infrastructure ; ports & adapters ; **5 règles** `dependency-cruiser` (`npm run boundaries`) → build cassé à toute violation (0/249 modules) | 1h00 | 1h00 | **2h00** |
...
- `README.md` — commandes, et l'état livré par ticket (BET-5→32).
