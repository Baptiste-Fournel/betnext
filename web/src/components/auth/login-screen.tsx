...
/**
 * Écran de login : username + mot de passe → `POST /auth/login` (via le contexte d'auth). Le token est
 * stocké et envoyé automatiquement par le middleware du client API. CLIENT MINCE : aucune logique
 * d'auth ici (le serveur authentifie ; on affiche juste le formulaire et l'erreur renvoyée).
 */
